@extends('frontend', ['title' => 'Tablero de control público de seguimiento del Plan de Acción 2015-2017 Colombia'])
@section('content')
...
<section id="tablero">
	<div class="container">
		<div class="row list-title">
			...
			<div class="col-sm-2">
				<h3>PRIMER AVANCE <small>31 de diciembre de 2015</small></h3>
			</div>
			<div class="col-sm-2">
				<h3>SEGUNDO AVANCE 	<small>30 de junio de 2016</small></h3>
			</div>
<!-- SE MODIFICA PARA ELIMINAR TERCER AVANCE (step_num = '4') -->
			<div class="col-sm-2">
				<h3>TERCER AVANCE <small>30 de junio de 2017</small></h3>
			</div>
			<div class="col-sm-2">
...
<!-- SE MODIFICA PARA AGREGAR CARACTERISTICAS-->

			<div class="col-xs-9 col-sm-3 ct">
				<p><h9>{{$commitment->characteristics}}: </h9>{{$commitment->title}}</p>
...
<!-- SE MODIFICA PARA ELIMINAR TERCER AVANCE (step_num = '4') -->
						     	...
						     	<li class="resultado_link {{$class_link}}"> 
							 		...
							 		<ul>
							 		    <li><div class="detalle">
							 		    	...
							 		    	<p class="row"><span class="col-md-6"><a class="resultado_link">Actividad</a><br>{{$objective->description}}</span>
							 		    		...
							 		    		@else
							 		    			@if ($objective->mir_url)
							 		    				...
							 		    				@if (!preg_match("~^(?:f|ht)tps?://~i", $url)) 
							 								<?php $url = "http://" . $url;?>
							 		 					@endif
							 							<span class="col-md-6"> <a href="{{$url}}" target="_blank" class="medios">Consulta el Avance</a></span>
							 		    			@endif
							 		    		@endif
							 		 		</p>
							 		 		...
							 		 		@endforeach
							 		 		<!-- MOSTRAR AVANCES <h3><p>Avance<br>{{$objective->advance_description}}</p></h3> -->
										<p>	@if ($objective->advance_description)
							 		 			<a>Sub-Actividades</a>
							 		 			<br/>
							 		 			<span class="more">
						...
						<!--- resultado final -->
							<ul>
								<li class="resultado_link">
									...
									<!--- SE CAMBIA LINEA /public/files/{{$objective->selfie}}-->

												<img src="/files/{{$objective->selfie}}" style="width:100%; height:auto;">
											@endif
		...
		@endforeach
		<!-- comienza disqus, se comenta la l�nea
		<div class="row">
