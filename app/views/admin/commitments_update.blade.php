...
<!-- MODIFICADO <label for="characteristics" class="col-sm-2 control-label">Características: </label>-->

      <label for="characteristics" class="col-sm-2 control-label">Objetivo: </label>
	  <div class="col-sm-8">
	  	@if(Auth::user()->user_type == "society")
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <a href="#" id="add-user" class="btn-sm btn-success">Agregar otro usuario</a>
    </div>
  </div>
   @endif
   ...
   <h3 class="text-center">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
      	<label class="col-sm-2 control-label">Meta {{$r++}}:</label>
	  	<div class="col-sm-8">
	  		@if ($objective->step_num != 4)
				...
				<!-- agrega enlaces para eliminar, editar y finalizar actividad-->
      			<p><span class="{{$status}}"> </span> 
      				...
      				{{$status_t}} | {{link_to('objective/' . $objective->id . '/edit', 'Editar Información de Metas',array("class"=>"btn btn-xs btn-default"))}} | 
		  			<!-- si ya está en proceso -->
		  			{{ $status == "proceso" ? link_to('objective/conclude/' . $objective->id, 'Finalizar Meta', array("class"=>"btn btn-xs btn-primary")) : ""}}
		  			...
		  			<input type="submit" form="delete-objective-{{$objective->id}}" class="btn btn-xs btn-danger" value="Eliminar Meta">
		  			@endif
      			</p>
      			@else 
      ...
      <div class="col-sm-8 col-sm-offset-2">
      	<p>
      	<input type="submit" form="add-objective-{{$step->id}}" class="btn btn-xs btn-success"/ value="Agregar otra meta"></p>
      </div>
      @endif
